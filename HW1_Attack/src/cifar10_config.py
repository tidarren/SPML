...
model_configs = {
    model_name(ResNet18): (ResNet18, 'checkpoints/resnet18_epoch_347_acc_94.77.pth'),
    model_name(DenseNet121): (DenseNet121,'checkpoints/densenet121_epoch_315_acc_95.61.pth'),
    model_name(GoogLeNet): (GoogLeNet, 'checkpoints/googlenet_epoch_227_acc_94.86.pth'),
    model_name(SENet18): (SENet18, 'checkpoints/senet18_epoch_279_acc_94.59.pth')
}
